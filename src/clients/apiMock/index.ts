...
export const setUpMock = async () => {
  ...
  mockFullmaktsgiver &&
    fetchMock.get(`${apiUrl}/fullmaktsgiver/12345678901`, delay(10, 50).then(() => fullmaktsgiver));
  mockFullmektig &&
    fetchMock.get(`${apiUrl}/fullmektig/12345678901`, delay(10, 50).then(() => fullmektig));
