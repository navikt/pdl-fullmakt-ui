    ...
    <>
      ...
      <div className="pagecontent">
        ...
        <Veilederpanel svg={<img src={VeilederIcon} alt="Veileder" />}>
          Ønsker du å logge inn? <br /> Vi anbefaler at du logger inn, så slipper du å
          fylle inn all informasjonen om deg selv.
        </Veilederpanel>
        <div className="fullmakt__login-content">
          ...
          <div className="lenke">
            <Link to={`${baseUrl}/fullmakt`}>Fortsett uten å logge inn</Link>
          </div>
        </div>
      </div>
    </>
